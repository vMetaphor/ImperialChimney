...
const groupDefinitions = [
  {
    ...
    metaDescription:
      "Imperial Chimney & Masonry provides chimney sweeping, chimney repair, chimney stucco repair, masonry repair, and pressure washing across Pottstown, Norristown, Collegeville, Limerick, and nearby Montgomery County communities.",
    intro:
      "We handle chimney sweeping, chimney repair, stucco repair, masonry restoration, and pressure washing throughout Pottstown, Norristown, Collegeville, Limerick, and nearby Montgomery County communities.",
    overviewParagraphs: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Our published local pages currently focus on Pottstown, Norristown, Collegeville, and Limerick, and we also work in nearby communities such as Sanatoga and Royersford."
      },
      {
